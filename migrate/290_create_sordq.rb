Sequel.migration do
  change do
     create_table(:sordq) do
      ...
      column :so_ship_vi, :varchar, :size => 20
      ...
      column :so_ca_id, :varchar, :size => 13
      ...
      column :so_disc_co, :varchar, :size => 6
      column :so_collect, :varchar, :size => 30
      column :so_deliver, :varchar, :size => 25
    end
  end
end
