Sequel.migration do
  change do
     create_table(:schedule) do
      ...
      column :sd_parts_p, :integer
      column :sd_qty_bal, :integer
      ...
      column :sd_parts_g, :integer
      column :sd_parts_b, :integer
      column :sd_gp, :float
      column :sd_np, :float
      ...
      column :sd_rework, :integer
      column :sd_scrap, :integer
